...
from config import COINMARKETCAP_API_KEY, SELENIUM_WEBDRIVER_PATH, SCREENSHOTS_DIR, TWITTER_CONSUMER_KEY, TWITTER_CONSUMER_SECRET, TWITTER_ACCESS_TOKEN, TWITTER_ACCESS_TOKEN_SECRET
